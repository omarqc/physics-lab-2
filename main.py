...
def update(N=1, x=[], y=[], devs=[], func="", curve="", plot="", mag=[], ON=True):
...
while True:
    ...
    if keyboard.is_pressed("r"):
        ...
        try:
            ...
            update(N=3, x=[times1x, times1y, times1z], y=[B_x, B_y, B_z], devs=[DEVICES["gaussmeter0"],DEVICES["gaussmeter1"],DEVICES["gaussmeter2"]], func=get_magnetic_field, 
                curve=curve1, plot=magnetic_field_plot, mag=B_mag, ON=True)
